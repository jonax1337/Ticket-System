/*
  ...
  - You are about to drop the column `emailMonochromeLogo` on the `system_settings` table. All the data in the column will be lost.
...
INSERT INTO "new_system_settings" ("appName", "automationCheckInterval", "automationCloseDays", "automationEnabled", "automationWarningDays", "createdAt", "emailBaseTemplate", "emailBaseTemplateActive", "emailDisclaimerText", "emailFixedHeaderColor", "emailHeaderColor", "emailHideAppName", "emailHideSlogan", "emailShowLogo", "emailSubjectPrefix", "hideAppName", "id", "lastTicketNumber", "logoUrl", "slogan", "themeColor", "ticketNumberLength", "ticketNumberType", "ticketPrefix", "updatedAt") SELECT "appName", "automationCheckInterval", "automationCloseDays", "automationEnabled", "automationWarningDays", "createdAt", "emailBaseTemplate", "emailBaseTemplateActive", "emailDisclaimerText", "emailFixedHeaderColor", "emailHeaderColor", "emailHideAppName", "emailHideSlogan", "emailShowLogo", "emailSubjectPrefix", "hideAppName", "id", "lastTicketNumber", "logoUrl", "slogan", "themeColor", "ticketNumberLength", "ticketNumberType", "ticketPrefix", "updatedAt" FROM "system_settings";
